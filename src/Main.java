public class Main {
    public static void main(String[] args) {
        ...
        */
         ...
         */
        //CigarParty ob1 = new CigarParty();
        //ob1.cigarParty(30,false);

        /*
        You and your date are trying to get a table at a restaurant. The parameter "you" is the stylishness of your clothes, in the range 0..10, and "date" is the stylishness of your date's clothes. The result getting the table is encoded as an int value with 0=no, 1=maybe, 2=yes. If either of you is very stylish, 8 or more, then the result is 2 (yes). With the exception that if either of you has style of 2 or less, then the result is 0 (no). Otherwise the result is 1 (maybe).
         */
        //DateFashion ob1 = new DateFashion();
        //ob1.dateFashion(5,10);

        /*
        The squirrels in Palo Alto spend most of the day playing. In particular, they play if the temperature is between 60 and 90 (inclusive). Unless it is summer, then the upper limit is 100 instead of 90. Given an int temperature and a boolean isSummer, return true if the squirrels play and false otherwise.
         */
        //SquirrelPlay ob1 = new SquirrelPlay();
        //ob1.squirrelPlay(70, false);

        /*
        You are driving a little too fast, and a police officer stops you. Write code to compute the result, encoded as an int value: 0=no ticket, 1=small ticket, 2=big ticket. If speed is 60 or less, the result is 0. If speed is between 61 and 80 inclusive, the result is 1. If speed is 81 or more, the result is 2. Unless it is your birthday -- on that day, your speed can be 5 higher in all cases.
         */
        //CaughtSpeeding ob1 = new CaughtSpeeding();
        //ob1.caughtSpeeding(60,false);

        /*
        Given 2 ints, a and b, return their sum. However, sums in the range 10..19 inclusive, are forbidden, so in that case just return 20.
         */
        //SortaSum ob1 = new SortaSum();
        //ob1.sortaSum(3,4);
         ...
         */
        //TwoAsOne ob1 = new TwoAsOne();
        //ob1.twoAsOne(1,2,3);

        /*
        Given three ints, a b c, return true if b is greater than a, and c is greater than b. However, with the exception that if "bOk" is true, b does not need to be greater than a.
         */
        //InOrder ob1 = new InOrder();
        //ob1.inOrder(1,2,4,false);
         ...
         */
        //InOrderEqual ob1 = new InOrderEqual();
        //ob1.inOrderEqual(2,5,11,false);

        /*
        Given three ints, a b c, return true if two or more of them have the same rightmost digit. The ints are non-negative.
         */
        //LastDigit2 ob1 = new LastDigit2();
        //ob1.lastDigit(23,19,13);

        /*
        Given three ints, a b c, return true if one of them is 10 or more less than one of the others.
         */
        //LessBy10 ob1 = new LessBy10();
        //ob1.lessBy10(1,7,11);

        /*
        Return the sum of two 6-sided dice rolls, each in the range 1..6. However, if noDoubles is true, if the two dice show the same value, increment one die to the next value, wrapping around to 1 if its value was 6.
         */
        //WithoutDoubles ob1 = new WithoutDoubles();
        //ob1.withoutDoubles(2,3,true);
         ...
         */
        //ShareDigit ob1 = new ShareDigit();
        //ob1.shareDigit(12,23);
